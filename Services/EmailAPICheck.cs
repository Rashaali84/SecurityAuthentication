...
using SecurityAuthentication.Models;


namespace SecurityAuthentication.Services
{
    ...
    public class EmailAPICheck : IEmailCheckRisky
        {
            ...
            var emailRepApiKey = "7w06xw104v6aenrpco4ks8bq77qdvooeonzma2nsukvio5im";
                HttpWebRequest repEmailRequest = (HttpWebRequest)WebRequest.
                Create($"https://emailrep.io/{emailAddress}");
                ...
                //if (reputation.suspicious || reputation.details.blacklisted ||
                //reputation.details.spam ||
               // reputation.details.malicious_activity ||
                //reputation.details.malicious_activity_recent)
                    //return true;
